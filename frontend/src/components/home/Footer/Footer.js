...
function Footer(props) {
    return (
        <footer className="position-sticky bottom-0 text-gray-600 bg-gray-200 body-font border">
                ...
                <div className="flex flex-wrap md:text-left text-center order-first">
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <div
                            ...
                            <div className=" gap-1 relative flex w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                                <input type="text" id="footer-field" name="footer-field"
                                       className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-gray-700 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
                                <button
            ...
            <div className="bg-gray-100">
                <div
                    className="container px-5 py-3 mx-auto d-flex justify-content-center align-items-center  sm:flex-row">
                    ...
                    <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 ">© 2020 Tailblocks —
